...
def main():
    ...
    # findtemplates.printNoMatches("Conditions.csv", "tenement_templates_regex.csv", "CondText")
    ...
    # miningTenementTemplate.stripDuplicateRegex("tenement_templates_regex.csv", "tenement_templates_regex_dupes_removed.csv")
