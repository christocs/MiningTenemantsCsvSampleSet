...
def main():
    ...
    profile.run('miningTenementTemplate.generateRegex("tenement_templates_fixed.csv", "tenement_templates_regex.csv")')
    ...
    # profile.run('findtemplates.printNoMatches("Conditions.csv", "tenement_templates_regex.csv", "CondText", False, False)')
    profile.run('findtemplates.printNoMatches("Conditions.csv", "tenement_templates_regex.csv", "CondText", True, False)')
